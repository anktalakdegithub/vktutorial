<?php 
$page_title="ICSE Board-VK'S Tutorial's is Sign Of Success";
$page_description=" The ICSE examination is conducted by CISCE Board. It is only available to a limited number
...
<div class="container-fluid bg-primary py-5 hero-header mb-5">
    <div class="row py-3">
        <div class="col-12 text-center">
            ...
            <a href="icse.php" class="h4 text-white">Courses</a>
        </div>
    </div>
</div>
<!-- Hero End -->
...
<div class="container-fluid py-5 mb-5">
    <div class="container ">
        ...
        <h1 class="display-6 mb-4 text-center">International Certificate of Secondary Education</h1>
        <p class="text-center">
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-4 col-sm-12">
                ...
                <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>Weightage to Practical</h5>
            </div>
            <div class="col-md-4 col-sm-12">
            ...
            <div class="col-lg-12">
                ...
                <ul class="m-0 nav nav-fill nav-justified nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation"> <button class="active nav-link classes" id="home-tab"
                            ...
                            aria-selected="true"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> ICSE (V to
                            VII)</button>
                    </li>

...
<section class="py-5 header">
    <div class="container py-4">
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="card card-body text-center">
                    <h3><?=count($worksheet);?></h3>
                    <p>Total Worksheets
                </div>
            </div>
            <div class="col-md-2">
                <div class="card card-body text-center">
                    <h3><?=count($assignment);?></h3>
                    <p>Total Assignment
                </div>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-3">
                ...
                <div class="nav flex-column nav-pills nav-pills-custom" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link mb-3 p-3 shadow" id="study-tab" data-toggle="pill" href="#study" role="tab" aria-controls="study" aria-selected="false">
                        <span class="font-weight-bold small text-uppercase">Add Oral & writing</span>
                    </a>
 ...
 -->
                    ...
                    <div class="tab-pane" id="study" role="tabpanel" aria-labelledby="study-tab">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <button class="btn steps_btn" type="button" data-toggle="collapse" data-target="#collapsestudy" aria-expanded="false" aria-controls="collapsestudy">Add Oral & writing</button>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="ui search focus mt-30 lbel25">
                                       ...
                                       <div class="ui search focus mt-30 lbel25">
                                        <label> Date</label>
                                        <div class="ui left icon input swdh19">
                                        <input type="date" id="qw_date" class="form-control" name="">
                                      </div>
                                    </div>
                                       <div class="ui search focus mt-30 lbel25">
                                        <label> Start time</label>
                                        <div class="ui left icon input swdh19">
                                            <input type="time" id="qwstime" class="form-control" name="">
                                      </div>
                                    </div>
                                       <div class="ui search focus mt-30 lbel25">
                                        <label> End time</label>
                                        <div class="ui left icon input swdh19">
                                            <input type="time" id="qwetime" class="form-control" name="">
                                      </div>
                                    </div>
                                    <div class="ui search focus mt-30 lbel25">
                                        <label>Batch</label>
                            ...
                            ?>
                                ...
                                <div class="modal" id="editstudyModal_<?=$que->question_id;?>">
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      <div class="modal-body">
                                        <h5 class="modal-title" id="editstudyModal">Edit Oral & writing</h5><br>
                                            <div class="ui search focus lbel25">
                                                <label>Title</label>
                                                <div class="ui left icon input swdh19">
                                       ...
                                       <div class="ui search focus mt-30 lbel25">
                                        <label> Date</label>
                                        <div class="ui left icon input swdh19">
                                        <input type="date" id="qw_date_<?=$que->question_id;?>" class="form-control" name="" value="<?=$que->qw_date;?>">
                                      </div>
                                    </div>
                                       <div class="ui search focus mt-30 lbel25">
                                        <label> Start time</label>
                                        <div class="ui left icon input swdh19">
                                            <input type="time" id="qwstime_<?=$que->question_id;?>" class="form-control" name="" value="<?=$que->start_time;?>">
                                      </div>
                                    </div>
                                       <div class="ui search focus mt-30 lbel25">
                                        <label> End time</label>
                                        <div class="ui left icon input swdh19">
                                            <input type="time" id="qwetime_<?=$que->question_id;?>" value="<?=$que->end_time;?>" class="form-control" name="">
                                      </div>
                                    </div>
                                            <div class="ui search focus mt-30 lbel25">
                                            <label>Batch</label>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <p><a href="<?=$ppt->document_upload;?>" target="_blank"><i class="fas fa-chalkboard-teacher"></i> &nbsp;&nbsp; Document</a>&nbsp;&nbsp;&nbsp;<i class='fas fa-clock'></i> &nbsp;&nbsp;<?=date("d-M-Y", strtotime($ppt->submission_date)); ?> </p>
                                                    </div>
                                                    <div class="col-md-4 text-right">
                                                        <p>
                                                            <?php
                     ...
                     <div class="col-md-12">
                         <div class="card shadow rounded bg-white">
                             <div class="card-body">
                                 <div class="row">
                                     <div class="col-md-8">
                                     <a  href="<?=base_url();?>admin/course/exam_result?exam_id=<?=$exams->exam_id;?>&batch_id=<?=$exams->batch_id;?>" >   <h4 class="card-title"><?=$exams->Title;?>(<?=$exams->exam_type;?>)</h4></a>
                                         <p><i class="fa fa-calendar"></i> <?=$exams->exam_date;?> <?=$exams->start_time;?>-<?=$exams->end_time;?>
                                     </div>
                                     <div class="col-md-4 text-right">
                         ...
                         <h5 class="modal-title" id="editstudyModal">Edit Exam</h5><br>
                             ...
                             <div class="ui search focus lbel25 mt-30">
                                 ...
                                 <input type="date" data-plugin="dropify" data-default-file="" class="prompt srch_explore" name="date"
                                                        id="date_<?=$exams->exam_id;?>" value="<?=$exams->exam_date;?>" />
                               </div>
                             </div>
                             <div class="ui search focus mt-30 lbel25">
                                        <label>Batch</label>
...
<script type="text/javascript">
    ...
    $('#addquestionwrite').click(function(){
        ...
        formData.append('title', title);
        formData.append('desc', desc);
        formData.append('qw_date', $('#qw_date').val());
        formData.append('qwstime', $('#qwstime').val());
        formData.append('qwetime', $('#qwetime').val());
        $.ajax({
    ...
    $('body').on('click', '.updateassingmnet', function(){
        ...
        formData.append('pdf', pdf[0]);
        formData.append('title', title);
        formData.append('assignsubmitdate', assignsubmitdate);
        $.ajax({
    ...
    $('body').on('click', '.updatequestionw', function(){
        ...
        formData.append('title', title);
        formData.append('desc', desc);
        formData.append('qw_date', $('#qw_date_'+qid).val());
        formData.append('qwstime', $('#qwstime_'+qid).val());
        formData.append('qwetime', $('#qwetime_'+qid).val());
        $.ajax({
            ...
            success: function(data){
                if (data.code=="404") {
                    ...
                    swal("Oral & writing updated successfully!", "", "success");
                    setTimeout(function () {
                        swal.close();
                       //location.reload();
                    }, 1000);
    ...
    $('body').on('click', '.publishqw', function(){
        ...
        $.ajax({
            ...
            type: "post",
            success: function(data){
                 swal("Publish Oral & writing successfully!", "", "success");
                    setTimeout(function () {
                        swal.close();
                       location.reload();
                    }, 1000);
    ...
    $('body').on('click', '.unpublishqw', function(){
        ...
        $.ajax({
            ...
            type: "post",
            success: function(data){
                 swal("UnPublish Oral & writing successfully!", "", "success");
                    setTimeout(function () {
                        swal.close();
                       location.reload();
                    }, 1000);

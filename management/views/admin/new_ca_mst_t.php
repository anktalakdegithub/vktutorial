...
<div class="container">
  <div class="row">
          ...
          <div class="col-12">
           <div class="ui search focus lbel25">
             ...
             <div class="ui search focus mt-30 lbel25">
              ...
              <div class="ui left icon input swdh19">
                <input class="prompt srch_explore" type="file" name="fileupload" data-purpose="edit-course-title" maxlength="60" id="fileupload" value="">                  
              </div>
            </div>
               <div class="ui search focus mt-30 lbel25">
            ...
            <div class="ui search focus mt-30 lbel25">
                  ...
                  <div class="ui left icon input swdh19">
                    <input class="prompt srch_explore" type="date" id="pdate" data-purpose="edit-course-title" maxlength="60">                  
                  </div>
                </div><br>
   ...
   $('#msg').html('<div class="alert alert-primary"><i class="fa fa-spinner fa-spin"></i> Please wait post creating....</div>');
    $.ajax({
        url: "<?= base_url()?>admin/chalu_ghadamodi/addpost",
        data: formData,
        type: "post",
        headers: { 'IsAjax': 'true' },
        processData: false,

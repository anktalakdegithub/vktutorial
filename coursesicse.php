...
<div class="container-fluid py-5 mb-5">
    <div class="container ">
        <h5 class="text-primary text-center text-uppercase">ICSE Board</h5>
        <h1 class="display-6 mb-4 text-center">Indian Certificate of Secondary Education</h1>
        <p class="text-center">
        The ICSE examination is conducted by CISCE (Council for the Indian School
Certificate Examinations) Board. It is only available to a limited number 
of schools across the country. ICSE students are considered to be on par with the
students from CBSE
        </p>
        <div class="row mt-2">
            <div class="col-md-3 col-sm-12"></div>
            <div class="col-md-3 col-sm-12">
                <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>Comprehensive Syllabus</h5>
                <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>Weightage to practice</h5>
            </div>
            <div class="col-md-3 col-sm-12">
                <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>Globally recognized course</h5>
                <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>Free choice of Subjects</h5>
            </div>
        </div>
        <div class="col-md-3 col-sm-12"></div>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <ul class="m-0 nav nav-fill nav-justified nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation"> <button class="active nav-link classes" id="home-tab"
                            ...
                            aria-selected="true"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> ICSE (V to VII)</button>
                    </li>
                    <li class="nav-item" role="presentation"> <button class="nav-link classes" id="profile-tab"
                            data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab"
                            aria-controls="profile" aria-selected="false"> <i class="fa fa-graduation-cap" aria-hidden="true"></i>
                            ICSE (VIII to X) </button> </li>
                    <li class="nav-item" role="presentation"> <button class="nav-link classes" id="messages-tab"
                            ...
                            aria-controls="messages" aria-selected="false"> <i class="fa fa-graduation-cap" aria-hidden="true"></i>
                            ICSE (XI to XII Commerce) </button> </li>
                        ...
                        <table class="table table-bordered text-center">
                            <thead>
                                <tr>
                                  ...
                                  <h5 class="pt-2 text-white">ISCE (V to VII)</h5>
                    ...
                    <table class="table table-bordered text-center">
                            <thead>
                                <tr>
                                  ...
                                  <h5 class="pt-2 text-white">ISCE (VIII to X)</h5>
                    ...
                    <!-- <table class="table table-bordered text-center">
                            <thead>
                                <tr>
                                  ...
                                  <h5 class="pt-2 text-white"> ISCE (XI to XII Commerce)</h5>
            ...
            <div class="col-md-4">
                <div class="card h-100 wow slideInUp cardslide bg-light text-dark py-2" data-wow-delay="0.3s">
                    ...
                    <div class="card-body">
                       ...
                       <ul class=" mb-0">
                            <li>We teach according to the ability of the students because every student has different ability and different capacity of understanding</li>
            ...
            <div class="col-md-4">
                <div class="card h-100 wow slideInUp cardslide bg-light text-dark py-2" data-wow-delay="0.4s">
                    <div class="card-body">
                        ...
                        <p class="card-text">Taking Action Against The Weak Subject Or  Topic Of Student And Allotting Some Home-Work And Assignment For The  Same. If Demanded By Students We Go For Re-teaching </p>

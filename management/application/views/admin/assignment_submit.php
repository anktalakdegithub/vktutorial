        ...
        <div class="row">
         ...
         if(in_array("add", $course) || in_array("all", $course)){
           ?>
                 ...
                 <a href="<?=base_url();?>admin/course/add_assignment_submitted?assignment_id=<?=$assignment_id;?>&batch_id=<?=$batch_id;?>" class="btn btn-primary">
                    Add Submission
                </a>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="ui search focus lbel25 mt-30 d-flex">
                                                    ...
                                                    <div class="ui left icon">
                                                            <input type="checkbox" id="late_<?=$stu['id']?>" class="is_submitted mx-2"  name="is_late" <?php if ($stu['is_late']==1) {echo "checked";} ?>>
                                                    </div>
                                                </div>

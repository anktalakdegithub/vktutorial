        ...
        <div class="col-md-12">
          <ul id="progressbar">
            ...
            <div class="card">
                      ...
                      <div class="ui left icon input swdh19">
			            ...
			            <br>
                          ...
                          <div class="text-right">
			           	 		<button type="button" name="next" class="next action-button" value="<?=$tid;?>" id="addexam">Next</button>
                    </div>
                            </fieldset>
                ...
                <div class="row">
                  <div class="col-12">
                        <h4 style="color: #000;"><strong>Total Question:</strong><span id="tquestions">0</span>&nbsp;&nbsp;<strong>Total Marks:</strong><span id="tmarks">0</span></h4>
...
$('#addexam').click(function(){
   ...
   var instructions=tinyMCE.editors[$('#instructions').attr('id')].getContent();
    ...
    var type="<?=$ttype;?>";
	$.ajax({
		url:"<?php echo base_url(); ?>admin/course/addlecturetest",
        method:"POST",
        data:{tid:id,title:title,pmarks:pmarks,duration:duration,instructions:instructions,type:type},
        dataType:'json',
    ...
    url:"<?php echo base_url(); ?>admin/test/addquestion",
        ...
        success:function(data)
        {
          setTimeout(function () {
            ...
            var tquestions = parseInt($('#tquestions').html())+1;
            var tmarks = parseFloat($('#tmarks').html())+parseFloat(qmarks);
            $('#tquestions').html(tquestions);
            $('#tmarks').html(tmarks);
          }, 2000);

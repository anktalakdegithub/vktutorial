...
var c = current.getTime();
 start = setDateTime(new Date(current), '09:00:00');
  ...
  $.ajax({
   ...
   $(function () {       
        $.ajax({
            type: "GET",
            url: "http://sms.vktutorials.com:6005/api/v2/SendSMS?ApiKey=NH+W/OCqlPh8H/ydSpwJPsZd0JY15p8iRIX3Bv9/rEo=&ClientId=097be2ac-703f-4211-9857-ac5a7a297113&SenderId=SMSADS&Message=Hello&MobileNumbers=917709753886",
 ...
 function send_sms(message,numbers){
   var Jsondata = {
            'SenderId': 'SMSADS',
            'ApiKey': 'NH+W/OCqlPh8H/ydSpwJPsZd0JY15p8iRIX3Bv9/rEo=',
            'ClientId': '097be2ac-703f-4211-9857-ac5a7a297113',
            'Message': message,
            'MobileNumbers': numbers
        };
        $.ajax({
            type: "POST",
            url: "http://sms.vktutorials.com:6005/api/v2/SendSMS",
            dataType: 'jsonp',
            cors: true ,
            contentType:'application/json',
            secure: true,

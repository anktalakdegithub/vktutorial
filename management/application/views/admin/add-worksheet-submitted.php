...
<div class="row">
   <div class="col-md-12 order-12 order-md-1">
      <div class="row" id="load_data">
        ...
        <button class="btn btn-default steps_btn" name="save" id="save" value="<?=$worksheet_id;?>">Save</button>
      </div>
   </div>
</div>
</div>
<script type="text/javascript">
   $('#save').click(function(){
        ...
        data: {'sids':sids,'is_late':is_late,'worksheet_id':worksheet_id,'is_submitted':is_submitted,'remark':remark},
        type: "post",
        success: function(data){
            location.href="<?=base_url();?>admin/course/worksheet_submit?worksheet_id=<?=$worksheet_id;?>&batch_id=<?=$batch_id;?>";
        }
        });
   });
</script>
...
<div class="container-fluid bg-primary py-5 hero-header mb-5">
    <div class="row py-3">
        <div class="col-12 text-center">
            <h2 class="display-3 text-white animated zoomIn">Enquire Now</h2>
                ...
                <div class="enquire h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn"
                    ...
                    <form  method="POST">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-sm-6">
                                <input type="email" name="email" id="email" class="form-control bg-light border-0 einput" placeholder="Your Email"
                                >
                            </div>
                            <div class="col-12 col-sm-6">

                                <select class="form-select bg-light border-0 einput" name="class">
                            ...
                            <div class="col-12 col-sm-6">
                                <select class="form-select bg-light border-0 einput" name="grade">
                            ...
                            <div class="col-12 col-sm-12">
                                <input type="tel"  name="contactnum" id="contactnum" class="form-control bg-light border-0 einput" placeholder="Contact Number">
                            </div>
                            <div class="col-12">

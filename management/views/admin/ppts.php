  ...
  <style type="text/css">
		...
		<div class="row">
			<div class="col-md-8 col-12">	
				<h2 class="st_title"><i class="uil uil-analysis"></i>PPTs</h2><br>
			</div>		
       ...
       // if(in_array("add", $course) || in_array("all", $course)){
          ?>
          <a href="<?=base_url();?>admin/ppt/newppt" class="btn btn-default steps_btn" style="padding-top: 10px !important;">New PPT</a>  
          <?php
       // }
        ?>
			</div>			
...
<?php
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <?php 
     //if(in_array("edit", $course) || in_array("all", $course)){
      ?>
    <a class="dropdown-item" href="<?=base_url();?>admin/ppt/editppt?id=<?=$row->Id;?>">Edit</a>
    <?php 
 // }
 ...
 // }
  ?>
        ...
        <img class="card-img-top" src="<?=$row->Thumbnail;?>" alt="Card image" style="width: 100%;">
   </div>
 ...
 $('.updatesort').click(function(){
  var sids=[];
   ...
   $.ajax({
    ...
    var id=$(this).val();
   $('#dmsg_'+id).html('<div class="alert alert-primary"><i class="fa fa-spinner fa-spin"></i> Please wait deleting....</div>');
    $.ajax({
      url:"<?=base_url();?>admin/ppt/deleteppt",
          method:"POST",
          data:{id:id},
          success:function(data)
          {
